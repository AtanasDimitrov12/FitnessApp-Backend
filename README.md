...
```
cd existing_repo
git remote add origin https://git.fhict.nl/I530410/ia-s3-fitness-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fhict.nl/I530410/ia-s3-fitness-app/-/settings/integrations)
...
- [ ] [Set auto-merge](https://docs.gitlab.com/ee/userEntity/project/merge_requests/merge_when_pipeline_succeeds.html)
